...
function validarDados() {
  if (
    document.forms.formulario1.elements[0].value == "" ||
    document.forms.formulario1.elements[0].length < 10
  ) {
  ...
  if (
    document.forms.formulario1.elements["idEmail"].value == "" ||
  ...
  if (
    document.forms.formulario1.elements.idMensagem.value == "" ||
  ...
  if (
    !(
      document.forms.formulario1.elements.r1.checked ||
      document.forms.formulario1.r2.checked
    )
  ) {
